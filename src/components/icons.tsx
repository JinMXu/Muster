// Hand-drawn SVG icon set, Lucide style: stroke-based, 1.5 stroke width,
// round caps/joins, currentColor, 24 viewBox, 14px default size.
// Colors always inherit from the surrounding text color (text-muster-muted /
// text-muster-accent etc.) — never hardcoded.
import type { SVGProps } from "react";

export type IconProps = SVGProps<SVGSVGElement> & {
  /// Icon edge length in px (icons are drawn on a 24×24 grid).
  size?: number;
};

/// Shared base applying the common svg attributes; individual icons only
/// supply their paths.
...
/// Windows-style maximize glyph: a single square.
...
/// Windows-style restore glyph: two overlapping squares.
