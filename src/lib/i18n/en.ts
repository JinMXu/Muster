const en = {
  ...
  settings: {
    ...
    tabAbout: "About",
    behavior: "Behavior",
    terminalFont: "Terminal & Editor",
    editor: "Editor",
    systemIntegration: "System integration",
    install: "Install",
    explorerMenuDesc: "Open folders in Muster from the Explorer context menu",
    pathDesc: "Run the `muster` command from any terminal",
    aboutTitle: "About Muster",
    appearance: "Appearance",
    updates: "Software updates",
    updatesDesc: "Keep Muster up to date",
    githubRepo: "GitHub repository",
    githubRepoDesc: "Report issues and follow development",
    themeSystem: "system",
    themeLight: "light",
    themeDark: "dark",
    ...
    explorerMenu: "‘Open in Muster’ context menu",
    pathIntegration: "PATH integration",
    integrationsInstalled: "Installed",
    addToPath: "Add Muster to PATH",
    removeFromPath: "Remove Muster from PATH",
    openOnGithub: "Open",
    checkForUpdates: "Check for Updates\u2026",
    currentVersion: (props: { version: string }) => `Current version ${props.version}`,
    downloadUpdate: "Download Update",
    restartToUpdate: "Restart to Update",
    updateInstallError: "Failed to download or install update",
