const zh = {
  ...
  settings: {
    ...
    install: "安装",
    appearanceMode: "主题模式",
    explorerMenu: "「在 Muster 中打开」右键菜单",
    explorerMenuDesc: "在资源管理器右键菜单中快速打开项目",
    pathIntegration: "PATH 集成",
    pathDesc: "从任意终端运行 `muster` 命令",
    aboutTitle: "关于 Muster",
    appearance: "外观",
    updates: "软件更新",
    updatesDesc: "保持 Muster 为最新版本",
    githubRepo: "GitHub 仓库",
    githubRepoDesc: "报告问题或了解最新动态",
    themeSystem: "跟随系统",
    themeLight: "浅色",
    themeDark: "深色",
    ...
    currentVersion: (props: { version: string }) => `当前版本 ${props.version}`,
    downloadUpdate: "下载更新",
    restartToUpdate: "重启并更新",
    updateInstallError: "下载或安装更新失败",
    releaseChannel: "更新通道",
